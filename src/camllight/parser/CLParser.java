...
public class CLParser extends Parser {
	...
	public static final int
		...
		RULE_exp = 8, RULE_pattmatchmultiple = 9, RULE_pattmatchsingle = 10, RULE_prog = 11;
	public static final String[] ruleNames = {
		"exptuple", "pattmatch", "constant", "pattmatchcurried", "patt", "ident", 
		"patttuple", "function", "exp", "pattmatchmultiple", "pattmatchsingle", 
		"prog"
	};
	...
	public final PattmatchContext pattmatch() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(32); ((PattmatchContext)_localctx).pattmatchmultiple_0 = pattmatchmultiple();
			...
			case 3:
				...
				{
				setState(35); ((PattmatchContext)_localctx).pattmatchsingle_0 = pattmatchsingle();
	...
	public final PattContext patt() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(65); ((PattContext)_localctx).WILDCARD_0 = match(WILDCARD);
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(67); ((PattContext)_localctx).ident_0 = ident();
			...
			case 5:
				...
				{
				setState(75); ((PattContext)_localctx).constant_0 = constant();
	...
	private ExpContext exp(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(129); ((ExpContext)_localctx).exp_1 = exp(0);
				setState(130); match(24);
				setState(131); ((ExpContext)_localctx).exp_2 = exp(15);
			...
			case 3:
				...
				setState(135); ((ExpContext)_localctx).exp_0 = exp(0);
				setState(136); match(30);
				setState(137); ((ExpContext)_localctx).exp_1 = exp(13);
			...
			case 5:
				...
				setState(145); ((ExpContext)_localctx).exp_0 = exp(0);
			...
			case 6:
				...
				setState(152); ((ExpContext)_localctx).ident_0 = ident();
				setState(153); match(6);
				setState(154); ((ExpContext)_localctx).exp_1 = exp(0);
				setState(155); match(18);
				setState(156); ((ExpContext)_localctx).exp_2 = exp(0);
				setState(157); match(12);
				setState(158); ((ExpContext)_localctx).exp_3 = exp(0);
			...
			case 9:
				{
				setState(170); ((ExpContext)_localctx).ident_0 = ident();
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(195); ((ExpContext)_localctx).exp_1 = exp(18);
	...
	public final PattmatchmultipleContext pattmatchmultiple() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(228); ((PattmatchmultipleContext)_localctx).pattmatchsingle_0 = pattmatchsingle();
			setState(229); match(21);
			setState(230); ((PattmatchmultipleContext)_localctx).pattmatch_1 = pattmatch();
	...
	public final PattmatchsingleContext pattmatchsingle() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(233); ((PattmatchsingleContext)_localctx).patt_0 = patt();
	...
	public static final String _serializedATN =
		...
		"\3\3\2\2\2\36\37\7\27\2\2\37 \5\4\3\2 !\b\3\1\2!)\3\2\2\2\"#\5\24\13\2"+
		"#$\b\3\1\2$)\3\2\2\2%&\5\26\f\2&\'\b\3\1\2\')\3\2\2\2(\36\3\2\2\2(\"\3"+
		"\2\2\2(%\3\2\2\2)\5\3\2\2\2*+\7%\2\2+/\b\4\1\2,-\7$\2\2-/\b\4\1\2.*\3"+
		"\2\2\2.,\3\2\2\2/\7\3\2\2\2\60\62\5\n\6\2\61\60\3\2\2\2\62\63\3\2\2\2"+
