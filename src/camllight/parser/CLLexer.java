...
public class CLLexer extends Lexer {
	...
	public static final String[] tokenNames = {
		...
		"'fun'", "'||'", "';'", "'while'", "'&&'", "'='", "'for'", "'if'", "'<='", 
		"'&'", "'print'", "'('", "'do'", "'*'", "'->'", "'done'", "'to'", "'>='", 
		"'<'", "'|'", "'>'", "'_'", "'or'", "'begin'", "'else'", "'function'", 
		"'end'", "')'", "'+'", "'then'", "'not'", "WS", "NUM", "BOOL", "ID"
	};
	...
	public static final String _serializedATN =
		...
		"\3\2\2\2\u008a\u008b\7a\2\2\u008b.\3\2\2\2\u008c\u008d\7q\2\2\u008d\u008e"+
		"\7t\2\2\u008e\60\3\2\2\2\u008f\u0090\7d\2\2\u0090\u0091\7g\2\2\u0091\u0092"+
		"\7i\2\2\u0092\u0093\7k\2\2\u0093\u0094\7p\2\2\u0094\62\3\2\2\2\u0095\u0096"+
		"\7g\2\2\u0096\u0097\7n\2\2\u0097\u0098\7u\2\2\u0098\u0099\7g\2\2\u0099"+
		"\64\3\2\2\2\u009a\u009b\7h\2\2\u009b\u009c\7w\2\2\u009c\u009d\7p\2\2\u009d"+
		"\u009e\7e\2\2\u009e\u009f\7v\2\2\u009f\u00a0\7k\2\2\u00a0\u00a1\7q\2\2"+
		"\u00a1\u00a2\7p\2\2\u00a2\66\3\2\2\2\u00a3\u00a4\7g\2\2\u00a4\u00a5\7"+
		"p\2\2\u00a5\u00a6\7f\2\2\u00a68\3\2\2\2\u00a7\u00a8\7+\2\2\u00a8:\3\2"+
