...
public class ListFactoryTest implements AllFactory {
    ...
    public void testList() throws Exception {
        List l = (List)list().eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(l, new List());
        l = (List)list(lit(0)).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(l, new List(new Int(0)));
        l = (List)list(lit(0), lit(1)).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(l, new List(new Int(0), new Int(1)));
    }

    @Test
    public void testListPrefix() throws Exception {
        List l = (List)listPrefix(lit(0), list(lit(1))).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(l, new List(new Int(0), new Int(1)));
    }
    ...
    public void testListPrefixPatt() throws Exception {
        ...
        Environment env = (Environment)match(list(lit(0), lit(1)), headIsZero).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertNotNull(env);

        try {
            @SuppressWarnings("unused")
            Environment e = (Environment)match(list(lit(1), lit(0)), headIsZero).eval(new Environment(), new Forwards(), new Store(), new Null());
    ...
    public void testIntClosedInterval() throws Exception {
        List l = (List)intClosedInterval(lit(0), lit(1)).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(new List(new Int(0), new Int(1)), l);
    }

    @Test
    public void testListReverse() throws Exception {
        List l1 = (List)listReverse(list(lit(2), lit(1))).eval(new Environment(), new Forwards(), new Store(), new Null());
        List l2 = (List)list(lit(1), lit(2)).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(l2, l1);
    }
