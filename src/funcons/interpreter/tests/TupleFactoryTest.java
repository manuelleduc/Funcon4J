...
public class TupleFactoryTest implements AllFactory {
    ...
    public void testTuple() throws Exception {
        Tuple t = (Tuple)tuple().eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(new Tuple(), t);
        t = (Tuple)tuple(lit(0)).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(new Tuple(new Int(0)), t);
        t = (Tuple)tuple(lit(0), lit(1)).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(new Tuple(new Int(0), new Int(1)), t);
        t = (Tuple)tuple(lit(0), lit(1), lit(2)).eval(new Environment(), new Forwards(), new Store(), new Null());
    ...
    public void testTuplePrefix() throws Exception {
        Tuple t = (Tuple)tuplePrefix(lit(5), tuple()).eval(new Environment(), new Forwards(), new Store(), new Null());
        ...
        assertEquals(t, tuple(lit(1), lit(2), lit(3)).eval(new Environment(), new Forwards(), new Store(), new Null()));
    }
    ...
    public void testProject() throws Exception {
        ...
        Int i = (Int)project(lit(0), tup1).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(new Integer(1), i.intValue());
        i = (Int)project(lit(1), tup2).eval(new Environment(), new Forwards(), new Store(), new Null());
        assertEquals(new Integer(2), i.intValue());
        i = (Int)project(lit(2), tup3).eval(new Environment(), new Forwards(), new Store(), new Null());
    ...
    public void testTuplePrefixPatt() throws Exception {
        ...
        Environment env = (Environment)match(tuple(lit(1), lit(2)), pattBindXY).eval(new Environment(), new Forwards(), new Store(), new Null());
