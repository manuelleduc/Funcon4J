...
public class BindFactoryTest {
    ...
    public void testVar() throws Exception {
        Variable v = (Variable)alg.var("id").eval(new Environment(), new Null());
        assertEquals(v.stringValue(), "id");
    }

    @Test
    public void testBindValue() throws Exception {
        Environment env = (Environment)alg.bindValue(alg.var("id"), alg.lit(3)).eval(new Environment(), new Null());
        Variable v = (Variable)alg.var("id").eval(new Environment(), new Null());
    ...
    public void testBoundValue() throws Exception {
        Environment env = (Environment)alg.bindValue(alg.var("id"), alg.lit(3)).eval(new Environment(), new Null());
        Int i = (Int)alg.boundValue(alg.var("id")).eval(env, new Null());
    ...
    public void testScope() throws Exception {
        ...
        Int i = (Int)alg.scope(env2, alg.boundValue(alg.var("id"))).eval((Environment)env1.eval(new Environment(), new Null()), new Null());
