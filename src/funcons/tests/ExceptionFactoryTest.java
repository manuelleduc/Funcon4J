...
public class ExceptionFactoryTest {
    ...
    public void testPreferOver() throws Exception {
        ...
        Bool b = (Bool)alg.apply(alg.preferOver(f1, f2), alg.lit(0)).eval(new Environment(), new Null());
        assertTrue(b.boolValue());

        b = (Bool)alg.apply(alg.preferOver(f2, f1), alg.lit(1)).eval(new Environment(), new Null());
        assertTrue(b.boolValue());
    }
}
