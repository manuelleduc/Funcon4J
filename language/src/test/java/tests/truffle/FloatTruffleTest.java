...
public class FloatTruffleTest extends AbstractTruffleTest {
    ...
    public void testLit() throws Exception {
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "1.0;;", "fnc").build());
...
//        assertNotEquals(lit(1.0).eval(), lit(2.0).eval());
    ...
    public void testFloatAdd() throws Exception {
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "1.5 + 2.5;;", "fnc").build());
        assertEquals("4.0", getAndFlush());
//        assertEquals(lit(4.0).eval(), floatAdd(lit(1.5), lit(2.5)).eval());


        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "1 + 2.5;;", "fnc").build());
...
//        assertEquals(lit(-1.5).eval(), floatNegate(lit(1.5)).eval());
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "-1.5;;", "fnc").build());
        assertEquals("-1.5", getAndFlush());
    }

    @Test
    public void testFloatSubtract() throws Exception {
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "2.5 - 1.5;;", "fnc").build());
        assertEquals("1.0", getAndFlush());
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "2.5-1;;", "fnc").build());
        assertEquals("1.5", getAndFlush());
...
//        assertEquals(lit(1.5).eval(), floatSubtract(lit(2.5), lit(1)).eval());
    ...
    public void testFloatMultiply() throws Exception {
        ...
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "2.5 * 2;;", "fnc").build());
...
//        assertEquals(lit(5.0).eval(), floatMultiply(lit(2.5), lit(2)).eval());
    ...
    public void testFloatDivide() throws Exception {
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "3.75 / 1.5;;", "fnc").build());
        assertEquals("2.5", getAndFlush());
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "3.0 / 2;;", "fnc").build());
        assertEquals("1.5", getAndFlush());
...
//        assertEquals(lit(1.5).eval(), floatDivide(lit(3.0), lit(2)).eval());
    ...
    public void testFloatModulo() throws Exception {
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "4.0 mod 1.5;;", "fnc").build());
        assertEquals("1.0", getAndFlush());
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "2.5 mod 1;;", "fnc").build());
...
//        assertEquals(lit(0.5).eval(), floatModulo(lit(2.5), lit(1)).eval());
    ...
    public void testFloatPowerOf() throws Exception {
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "4.0 ** 2.0;;", "fnc").build());
        assertEquals("16.00000", getAndFlush());
        engine.eval(org.graalvm.polyglot.Source.newBuilder("fnc", "2 ** 1.5;;", "fnc").build());
